    ...
    public function ajukan($id)
    {
        ...
        if ($check) {
            ...
            if ($query) {
                ...
                $message = "<b><h3>Kepada. " . $perusahaan['nama_perusahaan'] . "</h3></b> <br> Pemberitahuan ada akun CDC yang melamar pada posisi " . $perusahaan['posisi'] . ". <br> Mohon kepada perusahaan melakukan verifikasi akun pada website CDC Itenas. <br> Pelamar yang telah diverifikasi akan lanjut ke tahap selajutnya sesuai yang akan dilaksanakan oleh perusahaan<br> Untuk melihat pemberitahuannya, silahkan login ke https://cdc.itenas.ac.id <br><br> Hormat kami, <br><br> <b>CDC Itenas</b> ";
                $config = array(
                    'protocol' => 'smtp',
