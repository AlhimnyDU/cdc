        ...
        <div class="card">
          <div class="card-body">
            <form class="form-label-left input_mask" method="POST" action="<?php echo site_url("login/addMahasiswa"); ?>">
              ...
              <div id="internal">
                <div class="col-md-12 form-group has-feedback">
                  <input type="number" class="form-control has-feedback-left" id="nrp" name="nrp" placeholder="NRP/NIM" required="" />
                  <span class="glyphicon glyphicon-credit-card form-control-feedback left" aria-hidden="true"></span>
                </div>
              </div>
              <div>
                ...
                <div class="col-md-12 form-group has-feedback">
                  ...
                  <span class="glyphicon glyphicon-key form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-12 form-group has-feedback">
                ...
                <div class="col-md-12 form-group has-feedback">
                  ...
                  <span class="glyphicon glyphicon-call form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-12 form-group has-feedback">
              ...
              <hr>
              <div>
                <button class="btn btn-primary btn-sm submit buttonSubmit">Daftar</button>
              </div>
              <div class="clearfix"></div>
              <div class="separator">
