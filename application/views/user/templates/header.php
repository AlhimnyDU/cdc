              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i>Pengembangan Karir<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo site_url() ?>user/pengajuan">Pengajuan Lamaran</a></li>
                    <li><a href="<?php echo site_url() ?>user/jobfair">Job Fair</a></li>
                    <li><a href="<?php echo site_url() ?>user/loker">Lowongan Kerja</a></li>
                  </ul>
                </li>
                <li><a href="<?php echo site_url() ?>user/cv"><i class="fa fa-file"></i>Personal Info</a></li>
              </ul>
            </div>
