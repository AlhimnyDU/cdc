                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="<?php echo site_url('perusahaan/pelamar/' . $row->id_loker) ?>"><i class="fa fa-users"></i> Pengajuan</a> |
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo site_url('perusahaan/addMagang') ?>" enctype="multipart/form-data">
                    <div class="row">
    ...
    <div id="editModal<?= $row->id_loker ?>" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo site_url('perusahaan/editMagang/' . $row->id_loker) ?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col col-lg-12">
                                <div class="form-group">
                                    <label>Nama Magang</label>
