                                            ...
                                            <tr>
                                                ...
                                                <?php foreach ($berkas as $r) {
                                                    foreach ($data as $d) {
                                                        if (($r->nama_syarat == $d->nama_berkas) && ($row->id_akun == $d->id_akun)) { ?>
                                                            <td><a href="<?php echo base_url('halaman/download/' . $d->file)
                                                                            ?>">Ada</a></td>
                                                        <?php  }
                                                        ?>
                                                <?php }
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($row->lamaran == "Menunggu Verifikasi") { ?>
                                                        <a class="btn btn-primary btn-sm" href="<?php echo site_url('admin/verifikasi/' . $row->id_lamaran) ?>"><i class="fa fa-check"></i> Terima</a> | <a class="btn btn-danger btn-sm beforeTolak" href="<?php echo site_url('admin/tolak_lamaran/' . $row->id_lamaran) ?>"><i class="fa fa-times"></i> Tolak</a>
