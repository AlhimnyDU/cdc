                                ...
                                <table id="" class="table table-striped table-bordered datatable" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no ?></td>
                                                <td> <?php echo $row->nomor_induk ?> - <?php echo $row->nama ?></td>
                                                <td><?php echo $row->email ?></td>
                                                <td><?php echo $row->telp ?></td>
                                                <td><?php echo $row->alamat ?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo site_url('admin/cv/' . $row->id_akun)  ?>"><i class="fa fa-user"></i> Data CV</a> |
                                                    <a class="btn btn-warning" href="" data-toggle="modal" data-target="#editModal<?= $row->id_akun ?>"><i class="fa fa-edit"></i></a> |
                                                    <a class="btn btn-danger beforeDelete" href="<?php echo site_url('admin/hapusMahasiswa/') . $row->id_akun ?>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
