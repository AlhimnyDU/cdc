    ...
    <div class="container d-flex">
      ...
      <div class="cta">
        <?php if ($this->session->userdata("nama") == NULL) { ?>
          ...
          <a href="<?php echo site_url('login/register') ?>" class="scrollto">Registrasi Perusahaan</a>
        <?php } ?>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <div class="text-light"><a href="<?php echo site_url() ?>"><img src="<?php echo site_url('assets/halaman/logo.png') ?>" alt=""></a> <img src="<?php echo site_url('assets/halaman/kampus_merdeka.png') ?>" style="margin-top: 2px;margin-left:5px ;"></div>
