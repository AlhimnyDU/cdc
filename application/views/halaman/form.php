                                            ...
                                            <div class="mb-3">
                                                ...
                                                <?php } else if ($row->jenis_jawaban == "kepentingan") { ?>
                                                    <div class="alert alert-light" role="alert">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $row->id_soal ?>" id="inlineRadio<?php echo $row->id_soal ?>_2" value="2">
                                                            <label class="form-check-label" for="inlineRadio<?php echo $row->id_soal ?>_2">Tidak Penting</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $row->id_soal ?>" id="inlineRadio<?php echo $row->id_soal ?>_3" value="3">
                                                            <label class="form-check-label" for="inlineRadio<?php echo $row->id_soal ?>_3">Penting</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $row->id_soal ?>" id="inlineRadio<?php echo $row->id_soal ?>_4" value="4">
